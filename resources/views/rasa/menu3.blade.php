...
<div class="utama">
    ...
    <div class="menu" style="width: 15rem; height:20rem;">
        ...
        <div class="menubody">
        <p class="nama">Coklat Keju Oreo</p>
        <p class="harga">Rp15000</p>
    ...
    <div class="menu2" style="width: 15rem; height:20rem;">
        <img src="img/menu.png" alt="">
        <div class="menubody2">
        <p class="nama2">Coklat Keju Oreo</p>
        <p class="harga2">Rp15000</p>
    ...
    <div class="menu3" style="width: 15rem; height:20rem;">
        <img src="img/menu.png" alt="">
        <div class="menubody3">
        <p class="nama3">Coklat Keju Oreo</p>
        <p class="harga3">Rp15000</p>
