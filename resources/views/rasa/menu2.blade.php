...
<div class="bungkus1">
  @foreach ($pancong as $idx => $pcg)
  <div class="menu" style="width: 15rem; height:20rem;">
    <img src="img/menu.png" alt="">
    <div class="menubody">
      <p class="nama">Coklat Keju</p>
      <p class="harga">Rp11000</p>
      <a href="/deskripsimenu" class="read">Read More</a>
    </div>
  </div>
  <div class="menu" style="width: 15rem; height:20rem;">
    <img src="img/menu.png" alt="">
...
<div class="bungkus2">
  <div class="menu2" style="width: 15rem; height:20rem;">
    <img src="img/menu.png" alt="">
    <div class="menubody2">
      <p class="nama2">Coklat Keju</p>
      <p class="harga2">Rp11000</p>
...
<div class="bungkus3">
  <div class="menu3" style="width: 15rem; height:20rem;">
    <img src="img/menu.png" alt="">
    <div class="menubody3">
      <p class="nama3">Coklat Keju</p>
      <p class="harga3">Rp11000</p>
