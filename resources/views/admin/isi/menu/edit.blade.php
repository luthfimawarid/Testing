...
<body>
<form action="{{ url('pancongs/'.$pcg->id) }}" method="post">
    @method('PATCH')
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleinputdeskripsi" name="deskripsi" value="{{ $admin->deskripsi }}">
    </div> 
    <div class="mb-3">
        <label for="exampleinputfoto" class="form-label">Foto</label>
        <input type="file" class="form-control" id="exampleinputfoto" name="foto" value="{{ $admin->foto }}">
    </div>
    {{-- <div class="mb-3">
