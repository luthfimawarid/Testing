...
<div class="content-container">
    ...
    <div class="text-container ">
        ...
        <a href="/about" class="button">Selengkapnya <i class="bi bi-arrow-right-circle"></i></a>
    </div>
</div>
<!-- kontent1 end -->
...
<div class="kategori">
    ...
    <div class="bungkus">
        <a href="/menu1" class="card">
            <div class="img-box">
                <img src="/img/image 10.png" alt="" width="50px" height="50px">
            </div>
            <div class="teks">
                <p>Menu 1 Rasa</p>
            </div>
        </a>
        <a href="/menu2" class="card1">
            <div class="img-box1">
                <img src="/img/image 10.png" alt="" width="50px" height="50px">
            </div>
            <div class="teks1">
